    ...
    <Menu.Menu position="right">
      {isPdfLoaded && (
        <>
          ...
          >
            <Dropdown.Menu>
              {/* <Dropdown.Item onClick={addText}>Adicionar Texto</Dropdown.Item> */}
              <Dropdown.Item onClick={addImage}>Adicionar Imagem</Dropdown.Item>
              {/* <Dropdown.Item onClick={addDrawing}>Adicionar Desenho</Dropdown.Item> */}
            </Dropdown.Menu>
          </Dropdown>
          <Menu.Item
            data-testid="save-menu-item"
            name={savingPdfStatus ? 'Salvando...' : 'Salvar'}
